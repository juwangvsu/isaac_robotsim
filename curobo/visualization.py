...
# TODO
def colorize_3dbboxes(bboxes_3d_data, bboxes_3d_rgb, num_channels=None):
    # TODO
    import omni
    from omni.syntheticdata import helpers, visualize
    """ Colorizes 3D bounding box data for visualization.

    """
    viewport = omni.kit.viewport.get_default_viewport_window()
    bboxes_3d_corners = bboxes_3d_data["corners"]
    ...
    rgb_data = bboxes_3d_rgb
    bboxed3D_rgb = visualize.colorize_bboxes_3d(projected_corners, rgb_data)
    # bboxed3D_rgb = np.array(bboxed3D_rgb)
    return bboxed3D_rgb
